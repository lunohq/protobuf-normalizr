...
var normalizeField = function normalizeField(field, entity, entities, normalizations) {
    ...
    var merge = arguments.length <= 5 || arguments[5] === undefined ? null : arguments[5];
...
var visitArray = function visitArray(obj, entities, normalizations) {
    var merge = arguments.length <= 3 || arguments[3] === undefined ? null : arguments[3];
...
var visitEntity = function visitEntity(entity, entities, normalizations) {
    var key = arguments.length <= 3 || arguments[3] === undefined ? null : arguments[3];
    var merge = arguments.length <= 4 || arguments[4] === undefined ? null : arguments[4];
...
function normalize(obj) {
    ...
    var entities = {};
    var normalizations = {};
    var result = visit(obj, entities, normalizations, key, merge);

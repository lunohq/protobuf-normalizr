...
var isProtobuf = function isProtobuf(obj) {
    return obj && obj.$type instanceof _protobufjs2['default'].Reflect.Message;
};
...
var visitProtobuf = function visitProtobuf(entity, entities, normalizations) {
    ...
    entity.$type.getChildren(_protobufjs2['default'].Reflect.Message.Field).map(function (field) {

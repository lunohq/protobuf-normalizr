...
function entityHasValueForField(_x10, _x11) {
    var _again = true;
...
var denormalizeEntity = function denormalizeEntity(entity, entityKey, key, state) {
    ...
    var requiredFields = arguments.length <= 5 || arguments[5] === undefined ? null : arguments[5];
...
function denormalize(key, builder, state, requiredFields) {
